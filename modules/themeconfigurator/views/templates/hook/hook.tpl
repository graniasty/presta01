...
<div id="htmlcontent_{$hook|escape:'htmlall':'UTF-8'}"{if $hook == 'footer'} class="footer-block col-xs-12 col-sm-4"{/if}>
	...
	<ul class="htmlcontent-home clearfix row">
            <div id="htmlcontent-header">
                <div class="col-xs-3">Sed ut perspiciatis unde omnis</div>
                <div class="col-xs-3">iste natus error sit voluptatem ac</div>
                <div class="col-xs-3">quis nostrud exercitation</div>
                <div class="col-xs-3">ullamco laboris nisi</div>
            </div>
		...
		{/foreach}
                <div id="htmlcontent-link">
                    <div class="col-xs-3">czytaj więcej</div>
                    <div class="col-xs-3">czytaj więcej</div>
                    <div class="col-xs-3">czytaj więcej</div>
                    <div class="col-xs-3">czytaj więcej</div>
            </div>
